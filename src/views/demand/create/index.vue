        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="头像" prop="avatar">
              <UploadImg v-if="!isEdit" :url="form.avatar" field="avatar" @onSuccess="handleChoose" />
              <img class="avatar" v-else :src="form.avatar" alt="avatar">
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="公司" prop="company">
              <el-input :disabled="isEdit" v-model="form.company" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职位" prop="job">
              <el-input :disabled="isEdit" v-model="form.job" />
            </el-form-item>
          </el-col>
        </el-row>
        <div class="title">对接信息<span>（信息描述得越详细越高效）</span></div>
        <el-form-item label="我的需求" prop="needs">
          <el-input type="textarea" :disabled="isEdit" v-model="form.needs" placeholder="示例：1.小程序开发 2.网站开发"/>
        </el-form-item>
        <el-form-item label="需求标签选择" prop="needs_tag" class="item-content">
          <el-select :disabled="isEdit" v-model="form.needs_tag" multiple placeholder="请选择">
            <el-option v-for="item in needs" :key="item.id" :label="item.title" :value="item.id" />
          </el-select>
        </el-form-item>
        <el-form-item label="我的资源" prop="resource">
          <el-input :disabled="isEdit" type="textarea" v-model="form.resource" placeholder="示例：1.100万粉丝群 2.日活1000+产品"/>
        </el-form-item>
        <el-form-item label="资源标签选择" prop="resource_tag" class="item-content">
          <el-select :disabled="isEdit" v-model="form.resource_tag" multiple placeholder="请选择">
        ...
        <el-form-item label="地址" prop="city">
          <div class="flex">
            ...
            <el-form-item label="" prop="address" class="item-content">
              <el-input :disabled="isEdit" v-model="form.address" placeholder="请输入所在详细地址" style="width: 300px;" />
            </el-form-item>
          </div>
        </el-form-item>
        <el-form-item label="联系方式" prop="contact">
          <el-input :disabled="isEdit" v-model="form.contact" />
        </el-form-item>
        <el-form-item label="类型" prop="type" class="item-content">
          <el-radio :disabled="isEdit" v-model="form.type" :label="1">个人</el-radio>
          <el-radio :disabled="isEdit" v-model="form.type" :label="2">公司</el-radio>
        </el-form-item>
        <el-form-item label="" prop="photo">
          <UploadImg v-if="!isEdit" :url="form.photo" field="photo" @onSuccess="handleChoose" />
          <img class="photo" v-else :src="form.photo" alt="avatar">
          <div v-if="!isEdit" class="item-content tip">{{ form.type === 1 ? '请上传个人工牌照' : '请上传公司营业执照' }}</div>
        </el-form-item>
